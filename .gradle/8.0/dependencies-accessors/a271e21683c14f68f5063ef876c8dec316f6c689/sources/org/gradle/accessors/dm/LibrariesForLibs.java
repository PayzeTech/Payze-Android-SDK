...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KoinAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KoinAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getViewmodel() { return create("koin.android.viewmodel"); }
    ...
    public static class ComAndroidVersionAccessors extends VersionFactory  {
        ...
        public ComAndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: com.android.application (8.1.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KoinVersionAccessors extends VersionFactory  {
         ...
         */
        public KoinAndroidVersionAccessors getAndroid() { return vaccForKoinAndroidVersionAccessors; }

    }

    public static class KoinAndroidVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("koin.android"); }

            /**
             * Returns the version associated to this alias: koin.android.viewmodel (2.0.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getViewmodel() { return getVersion("koin.android.viewmodel"); }
